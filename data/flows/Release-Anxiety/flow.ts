...
const flow: Flow = withTotals({
  id: "ReleaseAnxiety",
  position: 5,
  title: { ro: "Release Anxiety", en: "Release Anxiety" },
  name: { ro: "Release Anxiety", en: "Release Anxiety" },
  intro: { ro: "Release yourself from anxiety and panic attacks.", en: "Release yourself from anxiety and panic attacks." },
  description: { ro: "Release yourself from anxiety and panic attacks.", en: "Release yourself from anxiety and panic attacks." },
  image: { ro: "/data/flows/Release-Anxiety/cover-ro.jpg", en: "/data/flows/Release-Anxiety/cover-en.jpg" },
