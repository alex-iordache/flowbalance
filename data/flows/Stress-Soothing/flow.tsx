...
const roDescription = (
  <>
    <p>{"Stresul strânge corpul și îți îngustează gândirea. Pe parcursul a 12 zile, exersezi eliberarea micro-tensiunii, stabilizarea respirației și închiderea ciclurilor de stres, ca să te simți mai puțin „în alertă.” Folosește-l după muncă, după conflicte sau oricând simți presiune constantă."}</p>
  </>
);
const enDescription = (
  <>
    <p>{"Stress tightens the body and narrows your thinking. Across 12 days, you’ll practice releasing micro-tension, steadying breath, and finishing stress cycles so you feel less “on edge.” Use it after work, after conflict, or anytime you notice constant pressure."}</p>
  </>
);
