...
const roDescription = (
  <>
    <p>{"Vorbitul în public nu e doar o abilitate; e un antrenament pentru sistemul nervos. Acest flow reduce tensiunea din gât și piept, stabilizează respirația și te ajută să rămâi ancorat când ești văzut. Folosește-l înainte de prezentări sau pentru a construi treptat confort."}</p>
  </>
);
const enDescription = (
  <>
    <p>{"Public speaking isn’t just a skill; it’s nervous system training. This flow reduces throat and chest tension, steadies breath, and helps you feel grounded while being seen. Use it before presentations or to practice gradually building comfort."}</p>
  </>
);
