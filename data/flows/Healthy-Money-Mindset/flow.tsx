...
const roDescription = (
  <>
    <p>{"Banii pot activa rușine, urgență sau evitare. Acest flow te ajută să îți reglezi reacțiile ca să poți planifica, alege și acționa cu stabilitate. E util când îți faci buget, îți prețuiești munca, ceri mai mult sau treci prin incertitudine financiară."}</p>
  </>
);
const enDescription = (
  <>
    <p>{"Money can trigger shame, urgency, or avoidance. This flow helps you regulate those reactions so you can plan, choose, and act with steadiness. Great when you’re budgeting, pricing your work, asking for more, or facing financial uncertainty."}</p>
  </>
);
