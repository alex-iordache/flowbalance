...
const roDescription = (
  <>
    <p>{"Creșterea e rar liniară—iar poveștile îți amintesc asta. Narațiunile de aici susțin reziliența, curajul și disponibilitatea de a învăța din disconfort. Folosește-le când ai nevoie de perspectivă nouă, un strop de energie sau o reamintire că înaintezi."}</p>
  </>
);
const enDescription = (
  <>
    <p>{"Growth is rarely linear—and stories remind you of that. These narratives support resilience, courage, and the willingness to learn from discomfort. Use them when you need a fresh perspective, a spark, or a reminder that you’re moving forward."}</p>
  </>
);
