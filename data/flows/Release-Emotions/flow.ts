...
const flow: Flow = withTotals({
  id: "ReleaseEmotions",
  position: 4,
  title: { ro: "Elibereaza-ti emotiile", en: "Release Emotions" },
  name: { ro: "Elibereaza-ti emotiile", en: "Release Emotions" },
  intro: { ro: "Elibereaza emotiile stocate in corp.", en: "Release emotions stored at the body level." },
  description: { ro: "Elibereaza emotiile stocate in corp.", en: "Release emotions stored at the body level." },
  image: { ro: "/data/flows/Release-Emotions/cover-ro.jpg", en: "/data/flows/Release-Emotions/cover-en.jpg" },
