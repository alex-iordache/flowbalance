...
const flow: Flow = withTotals({
  ...
  description: { ro: "Only when we are sick do we begin to stay connected to our own body. In fact, illness itself represents a signal from the body that we need to slow down our daily pace, rest, and give it more attention. The body is our most important life partner, it supports us with energy in everything we do. That is why it is essential to stay connected to it and prevent illness.", en: "Only when we are sick do we begin to stay connected to our own body. In fact, illness itself represents a signal from the body that we need to slow down our daily pace, rest, and give it more attention. The body is our most important life partner, it supports us with energy in everything we do. That is why it is essential to stay connected to it and prevent illness." },
