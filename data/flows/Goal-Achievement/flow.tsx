...
const roDescription = (
  <>
    <p>{"Obiectivele eșuează când ne bazăm doar pe motivație. Acest flow susține consecvența: angajamente mici, priorități clare și abilitatea de a relua după o zi ratată. Folosește-l când ai nevoie de momentum, structură și un „pas următor” calm."}</p>
  </>
);
const enDescription = (
  <>
    <p>{"Goals fail when we rely on motivation alone. This flow supports consistency: small commitments, clear priorities, and the ability to restart after a missed day. Use it when you need momentum, structure, and a calm “next step.”"}</p>
  </>
);
