...
const roDescription = (
  <>
    <p>{"Unele zile ești fără energie; alte zile ești supra-stimulat. Acest flow te ajută să îți reglezi activarea astfel încât energia să fie stabilă și folosibilă. Vei exersa activare blândă, „downshift”-uri și ritmuri care susțin o zi echilibrată."}</p>
  </>
);
const enDescription = (
  <>
    <p>{"Some days you’re flat; other days you’re overstimulated. This flow helps you regulate arousal so your energy feels usable and stable. You’ll practice gentle activation, downshifts, and rhythms that support a balanced day."}</p>
  </>
);
