...
- Queries Axiom using APL (`/v1/query/_apl?format=tabular`) and returns:
  - `{ range, rows: [...] }`
...
- Stats page:
  ...
  - Range selector: `24h`, `7d`, `30d`, `365d`
  - Renders:
    - Top Categories
    - Top Flows
    - Top Practices
...
- We do **not** log user identifiers; stats are content-only aggregation.
