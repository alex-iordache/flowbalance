...
const roDescription = (
  <>
    <p>{"Încrederea crește când corpul se simte susținut și mintea clară. Acest flow combină ancorarea, postura și dialogul interior ca să te simți mai capabil în situații reale. Folosește-l înainte de conversații dificile, începuturi noi sau momente care te intimidează."}</p>
  </>
);
const enDescription = (
  <>
    <p>{"Confidence grows when your body feels supported and your mind feels clear. This flow blends grounding, posture, and inner dialogue so you feel more capable in real situations. Use it before challenging conversations, new starts, or moments that intimidate you."}</p>
  </>
);
