...
const roDescription = (
  <>
    <p>{"Somnul mai bun începe înainte de culcare: cobori activarea, eliberezi tensiunea și reduci zgomotul mental. Practicile de aici susțin o tranziție mai lină către somn și o relație mai blândă cu trezirile nocturne. Folosește-l seara sau oricând corpul e obosit, dar mintea nu se oprește."}</p>
  </>
);
const enDescription = (
  <>
    <p>{"Better sleep starts before bedtime: lower arousal, release tension, and reduce mental chatter. These practices support a smoother transition into sleep and a kinder relationship with nighttime wake-ups. Use it in the evening, or anytime your body feels tired but your mind won’t stop."}</p>
  </>
);
