...
const roDescription = (
  <>
    <p>{"Pozitiv nu înseamnă fals—înseamnă flexibil. Acest flow te antrenează să observi ce funcționează, să reîncadrezi obstacolele și să creezi o voce interioară mai blândă. Folosește-l dimineața sau când te simți pesimist, dur cu tine sau descurajat."}</p>
  </>
);
const enDescription = (
  <>
    <p>{"Positive doesn’t mean fake—it means flexible. This flow trains you to notice what’s working, reframe setbacks, and create a kinder inner voice. Use it in the morning or whenever you feel pessimistic, harsh, or discouraged."}</p>
  </>
);
