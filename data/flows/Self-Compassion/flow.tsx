...
const roDescription = (
  <>
    <p>{"Compasiunea de sine nu e slăbiciune; e reglare plus sinceritate. Acest flow te ajută să înmoi auto-judecata, să revii după greșeli și să construiești un spațiu interior mai sigur. Folosește-l când ești dur cu tine, rușinat sau epuizat de prea multă forțare."}</p>
  </>
);
const enDescription = (
  <>
    <p>{"Self-compassion is not weakness; it’s regulation plus honesty. This flow helps you soften self-judgment, recover after mistakes, and build a safer inner environment. Use it when you’re harsh, ashamed, or exhausted from pushing too hard."}</p>
  </>
);
