...
const flow: Flow = withTotals({
  ...
  position: 6,
  title: { ro: "Sleep Regeneration", en: "Sleep Regeneration" },
  name: { ro: "Sleep Regeneration", en: "Sleep Regeneration" },
  intro: { ro: "Escape insomnia. Rest. Regenerate.", en: "Escape insomnia. Rest. Regenerate." },
  description: { ro: "Escape insomnia. Rest. Regenerate.", en: "Escape insomnia. Rest. Regenerate." },
  image: { ro: "/data/flows/Sleep-Regeneration/cover-ro.jpg", en: "/data/flows/Sleep-Regeneration/cover-en.jpg" },
