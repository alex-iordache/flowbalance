...
const flow: Flow = withTotals({
  ...
  description: { ro: "The mind can be a tsunami of routines, activities, conditioned behaviors, commitments, intentions and desires. Add to this the unknown, unplanned and unexpected uncertainties that unfold with every message, email, phone call or conversation, and before you know it... you've been swept away by a wave of reactivity and lost track of the goal you set out to achieve.", en: "The mind can be a tsunami of routines, activities, conditioned behaviors, commitments, intentions and desires. Add to this the unknown, unplanned and unexpected uncertainties that unfold with every message, email, phone call or conversation, and before you know it... you've been swept away by a wave of reactivity and lost track of the goal you set out to achieve." },
