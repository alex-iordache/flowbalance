...
const roDescription = (
  <>
    <p>{"Competiția amplifică totul: emoții, așteptări și dialog interior. Practicile de aici te ajută să canalizezi adrenalina în focus, să revii după greșeli și să rămâi „în banda ta.” E grozav cu o zi înainte de eveniment, în dimineața lui sau imediat după."}</p>
  </>
);
const enDescription = (
  <>
    <p>{"Competition amplifies everything: nerves, expectations, and self-talk. These practices help you channel adrenaline into focus, recover after errors, and stay in your lane. Great the day before an event, on the morning of, or right after."}</p>
  </>
);
