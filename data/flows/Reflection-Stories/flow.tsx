...
const roDescription = (
  <>
    <p>{"Reflecția te schimbă fără să te forțeze. Poveștile de aici creează spațiu pentru întrebări, sens și auto-observare sinceră. Folosește-le când vrei să procesezi evenimente, emoții sau decizii cu mai multă profunzime și mai puțin zgomot."}</p>
  </>
);
const enDescription = (
  <>
    <p>{"Reflection changes you without forcing you. These stories create space for questions, meaning, and honest self-observation. Use them when you want to process life events, emotions, or decisions with more depth and less noise."}</p>
  </>
);
