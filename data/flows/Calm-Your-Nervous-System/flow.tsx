...
const roDescription = (
  <>
    <p>{"Acest flow este o reconfigurare blândă: ritm de respirație, semnale din corp și atenție care te învață reglarea. Vei construi un „setare implicită” mai calmă care se vede în conversații, somn și decizii. Repetă zilele care îți plac—consecvența bate intensitatea aici."}</p>
  </>
);
const enDescription = (
  <>
    <p>{"This flow is a gentle re-patterning: breath pacing, body cues, and attention that teaches regulation. You’ll build a calmer “default setting” that shows up in conversations, sleep, and decision-making. Repeat the days you love—consistency beats intensity here."}</p>
  </>
);
