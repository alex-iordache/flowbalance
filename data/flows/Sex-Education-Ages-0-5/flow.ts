...
const flow: Flow = withTotals({
  id: "Ages0to5",
  position: 8,
  title: { ro: "Sex Education Ages 0-5", en: "Sex Education Ages 0-5" },
  name: { ro: "Sex Education Ages 0-5", en: "Sex Education Ages 0-5" },
  intro: { ro: "Sex education program for children ages 0-5.", en: "Sex education program for children ages 0-5." },
  description: { ro: "Sex education program for children ages 0-5.", en: "Sex education program for children ages 0-5." },
  image: { ro: "/data/flows/Sex-Education-Ages-0-5/cover-ro.jpg", en: "/data/flows/Sex-Education-Ages-0-5/cover-en.jpg" },
