...
const flow: Flow = withTotals({
  id: "Ages15to18",
  position: 12,
  title: { ro: "Sex Education Ages 15-18", en: "Sex Education Ages 15-18" },
  name: { ro: "Sex Education Ages 15-18", en: "Sex Education Ages 15-18" },
  intro: { ro: "Sex education program for children ages 15-18.", en: "Sex education program for children ages 15-18." },
  description: { ro: "Sex education program for children ages 15-18.", en: "Sex education program for children ages 15-18." },
  image: { ro: "/data/flows/Sex-Education-Ages-15-18/cover-ro.jpg", en: "/data/flows/Sex-Education-Ages-15-18/cover-en.jpg" },
