...
const roDescription = (
  <>
    <p>{"Unele zile nu au nevoie de un „deep dive”—au nevoie de un lift. Practicile scurte de aici aduc căldură, perspectivă și un strop de optimism fără să nege realitatea. Folosește-l ca ritual zilnic pentru a-ți reseta tonul emoțional."}</p>
  </>
);
const enDescription = (
  <>
    <p>{"Some days don’t need a deep dive—they need a lift. These short practices bring warmth, perspective, and a touch of optimism without denying reality. Use it as a daily ritual to reset your emotional tone."}</p>
  </>
);
