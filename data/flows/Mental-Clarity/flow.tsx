...
const roDescription = (
  <>
    <p>{"Când capul e aglomerat, și deciziile simple par grele. Practicile de aici creează spațiu: mai puține bucle, mai multă perspectivă și o narațiune interioară mai calmă. Folosește-l când ești confuz, supra-stimulat sau ai nevoie de un reset curat."}</p>
  </>
);
const enDescription = (
  <>
    <p>{"When your head feels crowded, even simple decisions feel heavy. These practices create space: fewer loops, more perspective, and a calmer inner narrative. Use it when you’re confused, overstimulated, or craving a clean reset."}</p>
  </>
);
